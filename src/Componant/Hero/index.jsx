        ...
        <div className="relative ">
            ...
            <div className={`bg-slate-100 ${model && "opacity-78"}`}>
                <div className="banner w-full h-screen relative overflow-hidden" id='/' >
                   <video src="/image/landing.mp4" autoPlay loop muted/>
                    <div className="xl:absolute w-full h-full bottom-0 left-0 ">
                        <div className="absolute bottom-0  w-full h-full flex flex-col justify-center text-center  xl:p-4 space-y-5 px-3 xl:px-10">
                            <h1 className='text-5xl xl:text-6xl font-bold text-white'>Find Your Dream House</h1>
                            <p className='text-white xl:mx-52'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore qui itaque ducimus earum numquam facilis beatae maxime provident recusandae nisi. Quibusdam cum pariatur recusandae. Sit laborum neque eos labore asperiores?
                            </p>
